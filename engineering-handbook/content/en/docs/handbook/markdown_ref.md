...
date: 2017-07-14
description: >
  How to use markdown in the Handbook.
---
What is markdown? Start here: [markdown](https://guides.github.com/features/mastering-markdown).

If you are new to Markdown, you can view the following page side-by-side with the code to understand what markdown translates to.
