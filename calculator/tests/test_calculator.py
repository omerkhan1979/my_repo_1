"""
This module contains unit tests for the basic calculator functions defined in 
basic_calculator.py. It tests the functions add, subtract, multiply, and divide 
